...
export default function MainHeading() {
  return (
    <section
      id="main-heading"
      className="color-accent color-accent-content bg-grid-lines h-[45vh] sm:h-[55vh] md:h-[65vh] flex items-center box-content p-3 sm:p-4 md:p-5 gradient-"
    >
      <div className="color-base-100 color-base-content flex flex-col justify-center items-left gap-1 sm:gap-2 md:gap-3 rounded-xl p-5 sm:p-7 md:p-9 lg:p-11">
